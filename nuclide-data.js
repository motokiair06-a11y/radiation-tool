...
// --- 📡 検出器データベース（要素データ付き） ---
const DETECTOR_DATABASE = [
    { name: "自由空気電離箱", category: "気体電離", radiation: "X, γ", energy: "△", count: "△", elements: ["N", "O"], desc: "照射線量の絶対測定（国家標準）。装置が非常に大きく、日常的な測定には用いない。" },
    { name: "空洞電離箱", category: "気体電離", radiation: "X, γ", energy: "△", count: "△", elements: ["C", "H", "O", "N"], desc: "ファーマ型など。主に放射線治療における水吸収線量の標準測定に用いられる。" },
    { name: "井戸型電離箱", category: "気体電離", radiation: "γ", energy: "△", count: "△", elements: ["Ar"], desc: "核医学において、投与前のRI（放射性同位元素）の放射能量（ベクレル）を測定する（キュリーメーター）。" },
    { name: "比例計数管", category: "気体電離", radiation: "α, β", energy: "○", count: "○", elements: ["Ar", "C", "H"], desc: "電圧を上げ、気体増幅（電子雪崩）を起こさせたもの。α線とβ線の波高弁別（同時測定）が可能。" },
    { name: "中性子比例計数管", category: "気体電離, 中性子", radiation: "中性子", energy: "○", count: "○", elements: ["He", "B", "F"], desc: "内部に3HeやBF3ガスを封入し、熱中性子を測定する。" },
    { name: "GM計数管", category: "気体電離", radiation: "β, γ", energy: "×", count: "○", elements: ["Ar", "Ne", "Cl", "Br"], desc: "端窓型は表面汚染(β線)の測定、円筒型は空間線量率(γ線)の測定に使用。分解時間が長く数え落としに注意。" },
    { name: "NaI(Tl)", category: "シンチ", radiation: "γ", energy: "○", count: "○", elements: ["Na", "I", "Tl"], desc: "γ線のスペクトル分析（核種同定）に最も一般的。潮解性（水分を吸って劣化する性質）があるため密閉が必要。" },
    { name: "CsI(Tl)", category: "シンチ", radiation: "X, γ", energy: "○", count: "○", elements: ["Cs", "I", "Tl"], desc: "NaI(Tl)より潮解性が低く加工しやすい。X線撮影やCTの間接変換方式FPD（フラットパネルディテクタ）の蛍光体。" },
    { name: "BGO / LSO", category: "シンチ", radiation: "γ", energy: "○", count: "○", elements: ["Bi", "Ge", "O", "Lu", "Si"], desc: "密度が非常に高く、高いエネルギーのγ線を効率よく止める。主にPET装置の検出器として使用される。" },
    { name: "ZnS(Ag)", category: "シンチ", radiation: "α", energy: "○", count: "○", elements: ["Zn", "S", "Ag"], desc: "粉末状のシンチレータ。透過力の弱いα線を測るため、非常に薄く塗布してα線表面汚染サーベイメータに用いられる。" },
    { name: "プラスチック", category: "シンチ", radiation: "β", energy: "△", count: "○", elements: ["C", "H"], desc: "応答が極めて速く、大面積化が可能。自己吸収が少なく、主にβ線の表面汚染測定に用いられる。" },
    { name: "液体シンチレータ", category: "シンチ", radiation: "低エネルギーβ", energy: "○", count: "○", elements: ["C", "H", "O"], desc: "サンプルを直接発光液に溶かすため、自己吸収がゼロ。3Hや14Cの測定に特化。" },
    { name: "Ge半導体", category: "半導体", radiation: "γ", energy: "○", count: "○", elements: ["Ge"], desc: "γ線のエネルギー分解能が全検出器の中で最も高い（最強）。熱雑音を防ぐため液体窒素(-196℃)での冷却が必須。" },
    { name: "Si表面障壁型", category: "半導体", radiation: "α, β", energy: "○", count: "○", elements: ["Si"], desc: "α線など重荷電粒子のスペクトル測定に使用。通常は空気による減衰を防ぐため真空チャンバー内で使用する。" },
    { name: "CdTe / CZT", category: "半導体", radiation: "X, γ", energy: "○", count: "○", elements: ["Cd", "Te", "Zn"], desc: "常温（室温）で使用できる半導体検出器。エネルギー分解能が高く、直接変換方式のPCCTなどへの応用が進む。" },
    { name: "蛍光ガラス線量計 (RPL)", category: "蓄積発光", radiation: "X, γ", energy: "△", count: "×", elements: ["P", "O", "Ag"], desc: "銀賦活リン酸塩ガラスを使用。紫外線を当てると蛍光を発する。フェーディングが少ない。反復読み取り可能。ガラスバッジ。" },
    { name: "OSL線量計", category: "蓄積発光", radiation: "X, γ", energy: "△", count: "×", elements: ["Al", "O", "C"], desc: "酸化アルミニウム(Al2O3:C)を使用。緑色光(LEDなど)を当てて青い光を読み取る。感度が高く個人被ばく管理の主流。" },
    { name: "熱ルミネセンス線量計 (TLD)", category: "蓄積発光", radiation: "X, γ, 中性子", energy: "△", count: "×", elements: ["Li", "F", "Mg", "Cu", "P"], desc: "フッ化リチウム(LiF)などを使用。熱を加えると発光するが、一度読み取ると記録が消える。組織等価性が良い。" },
    { name: "輝尽性蛍光体 (IP)", category: "蓄積発光", radiation: "X", energy: "×", count: "×", elements: ["Ba", "F", "Br", "Eu"], desc: "CR(コンピューテッドラジオグラフィ)で使用。X線エネルギーを蓄積し、赤色レーザーを当てて青紫色の光(輝尽発光)を出す。" },
    { name: "a-Se (アモルファスセレン)", category: "蓄積発光", radiation: "X", energy: "×", count: "×", elements: ["Se"], desc: "直接変換方式FPDに使用。X線を直接電子・正孔対に変換するため、間接変換方式と比べて空間分解能（鮮鋭度）が高い。" },
    { name: "BF3比例計数管", category: "中性子", radiation: "熱中性子", energy: "×", count: "○", elements: ["B", "F"], desc: "ホウ素(10B)と熱中性子の核反応を利用し、発生したα線を測定。γ線の影響を波高弁別でカットしやすい。" },
    { name: "3He比例計数管", category: "中性子", radiation: "熱中性子", energy: "×", count: "○", elements: ["He"], desc: "3He(n,p)3H 反応を利用。BF3よりも検出効率（感度）が高い。" },
    { name: "核分裂計数管", category: "中性子", radiation: "熱・速中性子", energy: "×", count: "○", elements: ["U"], desc: "電極にウラン(235U)などを塗布し核分裂破片を測定。非常に強いγ線環境下（原子炉出力モニタ等）でも確実に測れる。" },
    { name: "反跳陽子比例計数管", category: "中性子", radiation: "速中性子", energy: "○", count: "○", elements: ["H", "C"], desc: "中性子が水素原子核（陽子）に衝突して弾き飛ばす「弾性散乱」を利用。速中性子のエネルギー測定が可能。" },
    { name: "レムカウンタ", category: "中性子", radiation: "熱〜速中性子", energy: "×", count: "○", elements: ["B", "F", "He", "C", "H"], desc: "中心に熱中性子検出器を置き、周りをポリエチレン等の減速材（ボナー球）で覆う。人体への影響(線量当量)を直接評価。" },
    { name: "固体飛跡検出器 (CR-39)", category: "中性子", radiation: "速中性子", energy: "×", count: "×", elements: ["C", "H", "O"], desc: "プラスチック素子。速中性子が弾き飛ばした反跳陽子のミクロな傷(飛跡)を化学エッチング(拡大)し顕微鏡でカウント。" }
];
